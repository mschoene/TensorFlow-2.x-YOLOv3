...
# Train options
#TRAIN_YOLO_TINY             = False #lets try this...
TRAIN_YOLO_TINY             = True #lets try this...
...
TRAIN_CLASSES               = "./model_data/forG_SB_classes.txt"
#TRAIN_ANNOT_PATH            = "mnist/mnist_train.txt"
TRAIN_ANNOT_PATH            = "./model_data/forG_SB_train.txt"

#TRAIN_CLASSES               = "./model_data/SB_CLASS_train_classes.txt"
##TRAIN_ANNOT_PATH            = "mnist/mnist_train.txt"
#TRAIN_ANNOT_PATH            = "./model_data/SB_CLASS_train_small.txt"

TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = "yolov3_custom"
TRAIN_LOAD_IMAGES_TO_RAM    = False # faster training, but need more RAM
TRAIN_BATCH_SIZE            = 8 # original 8
...
TRAIN_FROM_CHECKPOINT       = "checkpoints/yolov3_custom_Tiny"
TRAIN_LR_INIT               = 1e-4
TRAIN_LR_END                = 1e-6
TRAIN_WARMUP_EPOCHS         = 1 #2
TRAIN_EPOCHS                = 10

# TEST options
#TEST_ANNOT_PATH             = "mnist/mnist_test.txt"
#TEST_ANNOT_PATH             = "./model_data/SB_CLASS_test.txt"
TEST_ANNOT_PATH             = "./model_data/forG_SB_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
